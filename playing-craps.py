"""Roll a two six_sided die 6,000,000 times"""
import random as ran 

# face frequency counters 
frequency1 = 0 # this will never occur with two die, should remain 0 
frequency2 = 0 
frequency3 = 0 
frequency4 = 0 
frequency5 = 0 
...
for rolls in range(6_000_000): 
    face = ran.randrange(1,7) + ran.randrange(1,7)
